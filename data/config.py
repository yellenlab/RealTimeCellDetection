...
yolact_cell_config = yolact_resnet50_config.copy({
    'name': 'yolact_cell',
    'num_classes': 2,
    'max_size': 300,
    'backbone': yolact_resnet50_config.backbone.copy({
        'pred_scales': [[int(x[0] / yolact_resnet50_config.max_size * 300)] for x in yolact_resnet50_config.backbone.pred_scales],
    }),
})
